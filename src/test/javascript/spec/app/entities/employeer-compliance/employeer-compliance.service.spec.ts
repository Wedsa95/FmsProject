...
describe('Service Tests', () => {
    ...
    describe('EmployeerCompliance Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EmployeerComplianceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/employeer-compliances';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EmployeerCompliance', () => {
