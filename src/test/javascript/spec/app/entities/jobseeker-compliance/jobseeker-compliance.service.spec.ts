...
describe('Service Tests', () => {
    ...
    describe('JobseekerCompliance Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(JobseekerComplianceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/jobseeker-compliances';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return JobseekerCompliance', () => {
