...
describe('Service Tests', () => {
    ...
    describe('ConsultingExperience Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ConsultingExperienceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/consulting-experiences';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ConsultingExperience', () => {
