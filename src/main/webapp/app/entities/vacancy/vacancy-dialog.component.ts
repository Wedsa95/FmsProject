...
export class VacancyDialogComponent implements OnInit {
    ...
    private subscribeToSaveResponse(result: Observable<HttpResponse<Vacancy>>) {
        result.subscribe((res: HttpResponse<Vacancy>) =>
            this.onSaveSuccess(res.body), (res: HttpErrorResponse) => this.onSaveError());
    }

    private onSaveSuccess(result: Vacancy) {
...
@Component({
    selector: 'jhi-vacancy-popup',
    template: ''
})
export class VacancyPopupComponent implements OnInit, OnDestroy {
        ...
        this.routeSub = this.route.params.subscribe((params) => {
            if ( params['id'] ) {
                this.vacancyPopupService
                    .open(VacancyDialogComponent as Component, params['id']);
            } else {
                this.vacancyPopupService
                    .open(VacancyDialogComponent as Component);
            }
        });
    }
