...
@Component({
    ...
    templateUrl: './jobseeker-profile-dialog.component.html'
})
        ...
        this.routeSub = this.route.params.subscribe((params) => {
            if ( params['id'] ) {
                this.jobseekerPopupService
                    .open(JobseekerProfileDialogComponent as Component, params['id']);
            } else {
                this.jobseekerPopupService
                    .open(JobseekerProfileDialogComponent as Component);
            }
        });
    }
